...
public class BookDirectoryTestSuite {
    ...
    @Nested
    @DisplayName("Tests of functions with conditions")
    class BooksWithConditionTests {
        ...
        void testListBooksWithConditionsReturnList() {
            ...
            Book book2 = new Book("Secretaries and Directions", "Dilbert Michigan", 2012);
        ...
        @Test
        void testsListBooksWithConditionMoreThan20() {
            //Given
            BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
    ...
    @Nested
    @DisplayName("Tests with functions books in hands")
    class BooksInHandsTests {

        @Test
        public void testListBooksHandsOf0Books() {
            //Given
            BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
            List<Book> resultListOf0Books = new ArrayList<Book>();
            LibraryUser libraryUser = new LibraryUser("Name", "Surname", "123456789876");
        ...
        @Test
        public void testListBooksHandsOf1Books() {
            //Given
            BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        ...
        @Test
        public void testListBooksHandsOf5Books() {
            //Given
            BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
